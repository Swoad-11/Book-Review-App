...
const Home = () => {
  ...
  return (
    <div className="p-8">
      <section className="grid lg:grid-cols-2 sm:grid-cols-1 justify-items-center items-center home">
        <div className="book-image">
          <img
            className="border-double border-4 border-amber-500 mb-4"
            src="./sherlock.png"
            alt=""
          />
        </div>
        <div>
          <div>
            <h1 className="font-bold lg:text-6xl sm:text-4xl text-amber-600">
              Sherlock Holmes
            </h1>
            <h1 className="font-bold lg:text-4xl sm:text-2xl mb-4 text-amber-900">
              Your Consulting Detective
            </h1>
            <p className="font-medium">
              The lowest and vilest alleys in London do not present a more
